...
(*
  Here we show that our calculus is consistent.
*)
...
(* A function which applies a list of term to a term *)
...
(* This operation is can be simplified *)
Lemma applist_assoc :
...
(* inversion of list of terms getting applied *)
...
(* Atom term is a sequence terms applied to a variable *)
