...
let file_requiring_modes = ["test_renaming"; "reduction_step"; "normal_form"; "check"]
...
let () = 
	...
	| "normal_form" -> file_name |> read_file_contents |> StrToPreIr.convert_str |> PreIrToIr.convert_term |> Ir.find_normal_form |> IrToPreIr.convert_term |> PreIrToStr.convert_term |> Printf.printf "%s\n"
